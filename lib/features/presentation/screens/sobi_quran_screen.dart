                    ...
                    itemBuilder: (context, i) {
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: AppColors.primary_10.withOpacity(0.18),
                              blurRadius: 12,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // Surah List in Juz
                            ...List.generate(juz['surahs'].length, (j) {
                              final surah = juz['surahs'][j];
                              return Container(
                                ...
                                child: Row(
                                  children: [
                                    // Number with SVG background (replace with your SVG if needed)
                                    Stack(
